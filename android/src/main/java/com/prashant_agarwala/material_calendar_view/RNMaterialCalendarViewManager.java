...
package com.prashant_agarwala.material_calendar_view;
...
public class RNMaterialCalendarViewManager extends SimpleViewManager<MaterialCalendarView> {

  public static final String REACT_CLASS = "RNMaterialCalendarView";
